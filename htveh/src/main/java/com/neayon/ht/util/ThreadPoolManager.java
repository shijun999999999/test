...
/**
 * 类名称:ThreadPoolManager 类描述: 可根据Context控制任务生命周期线程池管理类
...
public class ThreadPoolManager {
	 ...
	 *
	 * 1、public static ExecutorService newFixedThreadPool(int nThreads) { return new
	 * ThreadPoolExecutor(nThreads, nThreads, 0L, TimeUnit.MILLISECONDS, new
	 * LinkedBlockingQueue<Runnable>()); }
	 *
	 * 2、 public static ExecutorService newSingleThreadExecutor() { return new
	 * FinalizableDelegatedExecutorService (new ThreadPoolExecutor(1, 1, 0L,
	 * TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>())); }
	 *
	 * 3、public static ExecutorService newCachedThreadPool() { return new
